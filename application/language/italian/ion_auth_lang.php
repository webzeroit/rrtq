...
$lang['account_creation_missing_default_group'] = 'Ruolo predefinito non impostato';
$lang['account_creation_invalid_default_group'] = 'Nome del ruolo predefinito non valido';
...
$lang['password_change_not_match']               = 'Vecchia password non valida.';
...
// Groups
$lang['group_creation_successful']  = 'Ruolo creato con successo';
$lang['group_already_exists']       = 'Nome ruolo gi&agrave; assegnato';
$lang['group_update_successful']    = 'Dettagli ruolo aggiornati';
$lang['group_delete_successful']    = 'Ruolo cancellato';
$lang['group_delete_unsuccessful'] 	= 'Impossibile cancellare il ruolo';
$lang['group_delete_notallowed']    = 'Impossibile eliminare il ruolo amministratore';
$lang['group_name_required'] 		= 'Il nome ruolo &egrave; un campo obbligatorio';
$lang['group_name_admin_not_alter'] = 'Il nome del ruolo amministratori non pu&ograve; essere modificato';

// Activation Email
$lang['email_activation_subject']           = 'Attivazione Account';
$lang['email_activate_heading']             = 'Attiva account per %s';
$lang['email_activate_subheading']          = 'Per attivare l\'utenza fai click sul link %s.';
$lang['email_activate_link']                = 'attivazione account';
// Forgot Password Email
$lang['email_forgotten_password_subject']   = 'Reimposta la tua password';
$lang['email_forgot_password_heading']      = 'Reimposta la Password per %s';
$lang['email_forgot_password_subheading']   = 'è sufficiente fare click sul seguente link %s.';
