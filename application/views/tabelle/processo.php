<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Processi</h4>
                <h6 class="card-subtitle">Elenco dei Processi definiti nel repertorio regionale</h6>
                <div class="table-responsive m-t-20 m-b-40">
                    <table id="dt_processo" class="display table table-hover table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>S.E.P.</th>
                ...
                <div class="button-group">                    
                    <a href="export_xls/processo" role="button" id="btn_export" name="btn_export" class="btn btn-info">Esporta in Excel</a>      
                </div>           
            </div>
        </div>  
    </div>
