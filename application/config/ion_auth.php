 ...
 */
$config['site_title']                 = "RRTQ - Repertorio Regionale Titoli e Qualificazioni";       // Site Title, example.com
$config['admin_email']                = "noreply@capire.regione.campania.it"; // Admin Email, admin@example.com
$config['default_group']              = 'collaboratore';           // Default group, use name
